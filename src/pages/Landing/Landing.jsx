      ...
      {[0, 1, 2].map(i => (
        <div key={i} className={styles.mockRow}>
          ...
          <div className={styles.mockTexts}>
            ...
            {i === 1 ? (
              <div className={styles.mockTallyWrap}>
                <div className={styles.mockTallyTrack}>
                  <div className={styles.mockTallyFill} />
                </div>
                <span className={styles.mockTallyLabel}>7 / 10</span>
              </div>
            ) : (
              <div className={`${styles.mockBar} ${styles.mockBarNarrow}`} />
            )}
          </div>
          {i === 2 && <span className={styles.sponsoredPill}>Sponsored</span>}
        </div>
      ))}
    </div>
  )
...
function StoresMock() {
  return (
    <div className={styles.mock}>
      <div className={styles.mockHeader}>Requests</div>
      {[0, 1, 2].map(i => (
        <div key={i} className={styles.mockRow}>
          <div className={styles.mockTexts}>
            <div className={`${styles.mockBar} ${styles.mockBarWide}`} />
          ...
          <div className={styles.mockActions}>
            <button className={styles.mockApprove} tabIndex={-1}>Approve</button>
            <button className={styles.mockLater} tabIndex={-1}>Later</button>
          </div>
        </div>
      ))}
    </div>
  ...
  return (
    <div className={styles.page}>
      ...
      <nav className={styles.landingNav}>
        <span className={styles.navWordmark}>CORNERS</span>
        ...
        <div className={styles.showcaseInner}>
          ...
          <div className={styles.showcaseBody}>
            <div className={styles.phoneFrame}>
              {activeTab === 'patrons'      && <PatronsMock />}
              {activeTab === 'stores'       && <StoresMock />}
